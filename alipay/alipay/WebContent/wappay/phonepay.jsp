...
<script language="javascript">
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "Iphone6 16G";
		document.getElementById("WIDtotal_amount").value = "88.88";
        document.getElementById("WIDbody").value = "Iphone6 16G";
	}
	GetDateNow();
</script>
</html>