...
//         写请求来了，就封装WriteCommand，交给同一个命令甘之类来执行即可
//
//         所以为什么要用这种模式呢？
//         其实很多时候，用模式，是采用模式的合理的思想，去良好的设计你的代码
//         你运用了模式之后，就可以很好地表达你的代码组件是干嘛的
//         调用一个工具类的某个方法，太恶心了，从面向对象设计的角度，你没有任何面向对象的设计，就是一个面向过程
//         面向方法在执行这个功能
//
//         如果你的面向对象的设计太烂的话，几乎没有设计，到了1年以后，你的系统的代码很难看懂，几乎没人能看懂
//         但是反过来说，按照设计模式体现出的优秀的面向对象设计的思想，来规划你的代码的设计，可能几年以后
//         别人过来，不通命令，代表了不同的逻辑，代码就很好理解，可读性，维护性，拓展性
//
//         构造器模式，builder，工厂模式
    }
